...
/* req NHK-753,hezhigang,20240413,add,begin */
...
/* req NHK-753,hezhigang,20240413,add,end */
/**
...
/* req NHK-753,hezhigang,20240413,add,begin */
	...
	if(ufs_get_value_of_cmdline()) {
             if(!ufshcd_query_flag_retry(hba, UPIU_QUERY_OPCODE_SET_FLAG,QUERY_FLAG_IDN_PWR_ON_WPE, 0, NULL)) {
		     pr_err("zhz_ufs_qcom_The USERDEBUG and ENG enable partition write protection successfully");
             }
        }
/* req NHK-753,hezhigang,20240413,add,end */
