...
*/
/*add drm driver,2023/11/08,begin*/
...
static int fts_notifier_callback_init(struct fts_ts_data *ts_data)
{
    ...
    if (ret) 
	FTS_ERROR("[DRM]msm_drm_register_client fail: %d\n", ret);
#endif //CONFIG_DRM_PANEL
