...
/*    if (dump_test_data_to_console || dump_test_data_to_file) {
    ...
    if (driver_validate_data) {
        ...
        if (ret) {
	     ...
	     cts_dump_tsdata(cts_dev, "GND-short", test_result, true );
            if (stop_if_failed) {
                goto recovery_display_state;
            }
        }
...
*/
		...
		cts_dump_tsdata(cts_dev, "Col-short", test_result, true );
                if (stop_if_failed) {
                    goto recovery_display_state;
                }
            }
...
/*        if (dump_test_data_to_console || dump_test_data_to_file) {
		...
		cts_dump_tsdata(cts_dev, "Row-short", test_result, true );
                if (stop_if_failed) {
                    goto recovery_display_state;
                }
            }
