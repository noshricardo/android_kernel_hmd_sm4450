        ...
        u32 hwid, u16 fwid, u16 curr_firmware_ver)
{
...
#ifdef CFG_CTS_FIRMWARE_IN_FS
    //if (strcmp(panel_name_find,"mdss_dsi_icnl9916_90hz_hd_lc_video") == 0){
   ...
   /* }else{
#ifndef CFG_CTS_FOR_GKI
    if (is_filesystem_mounted(CFG_CTS_FIRMWARE_FILEPATH_BOE))
#endif
        firmware_from_file = cts_request_newer_firmware_from_fs(cts_dev,
#ifdef CFG_CTS_FW_UPDATE_FILE_LOAD
        cts_dev->config_fw_name[0] ? cts_dev->config_fw_name : CFG_CTS_FIRMWARE_FILENAME_BOE,
#else
        CFG_CTS_FIRMWARE_FILENAME_BOE,
#endif
        firmware_builtin ? FIRMWARE_VERSION(firmware_builtin) : curr_firmware_ver);
    }*/
#endif /* CFG_CTS_FIRMWARE_IN_FS */
